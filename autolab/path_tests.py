...
PATH_TESTS: List[PathTest] = [
    ...
    PathTest("/courses/Course0/assessments", cookies=STUDENT_COOKIES, content_snippet="Quiz 4", is_page_main=True, tag2sleep_s={"original": .3, "modified": .3, "cached": .3, "no-cache": 0}),
