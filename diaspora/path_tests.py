...
PATH_TESTS: List[PathTest] = [
    # Simple post.
    PathTest("/posts/33000073", cookies=COOKIES, content_snippet="Here's a post for my #family.", is_page_main=True, tag2sleep_s={"original": .3, "modified": .3, "cached": .3, "no-cache": 5}),
    ...
    # Complex post.
    PathTest("/posts/33000071", cookies=COOKIES, content_snippet="A fourth poll!", is_page_main=True, tag2sleep_s={"original": .3, "modified": .3, "cached": .3, "no-cache": 16}),
    ...
    # Profile.
    PathTest("/people/30c2ef608e5c0139d94f011df6dc47b7", cookies=COOKIES, content_snippet="Homer Simpson", is_page_main=True, tag2sleep_s={"original": .3, "modified": .3, "cached": .3, "no-cache": 10}),
    ...
    # Conversation.
    PathTest("/conversations?conversation_id=12000002", cookies=COOKIES, content_snippet="Message 3.", is_page_main=True, tag2sleep_s={"original": .3, "modified": .3, "cached": .3, "no-cache": 3}),
    #   Notifications -- same as before.
]
